...
ALTER TABLE customerprocedures
    ADD CONSTRAINT customerprocedures_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customers (customer_id) ON DELETE NO ACTION;

ALTER TABLE customerprocedures
    ADD CONSTRAINT customerprocedures_procedure_id_fkey FOREIGN KEY (procedure_id) REFERENCES procedures (procedure_id) ON DELETE NO ACTION;

ALTER TABLE roombooking
    ADD CONSTRAINT roombooking_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customers (customer_id) ON DELETE NO ACTION;

ALTER TABLE roombooking
    ADD CONSTRAINT roombooking_hotel_room_id_fkey FOREIGN KEY (hotel_room_id) REFERENCES hotelrooms (hotel_room_id) ON DELETE NO ACTION;

ALTER TABLE roomusage
    ADD CONSTRAINT roomusage_procedure_id_fkey FOREIGN KEY (procedure_id) REFERENCES procedures (procedure_id) ON DELETE NO ACTION;

ALTER TABLE roomusage
    ADD CONSTRAINT roomusage_room_id_fkey FOREIGN KEY (room_id) REFERENCES rooms (room_id) ON DELETE NO ACTION;

ALTER TABLE roomusage
    ADD CONSTRAINT roomusage_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff (staff_id) ON DELETE NO ACTION;